...
function util.saveanim(anim: Animation)
	animationcache[#animationcache + 1] = util.gets("Players").LocalPlayer.Character:FindFirstChildOfClass("Humanoid"):LoadAnimation(anim)
	util.gets("StarterGui"):SetCore("SendNotification",{Text = "Set [" .. #animationcache .. "] to \"" .. anim:GetFullName() .. "\""; Duration = 10; Title = "Saved Animation"})
end
