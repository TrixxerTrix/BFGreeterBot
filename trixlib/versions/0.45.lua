...
function util.saveanim(anim: Animation)
	util[#util + 1] = util.gets("Players").LocalPlayer.Character:FindFirstChildOfCharacter("Humanoid"):LoadCharacter(anim)
	util.gets("StarterGui"):SetCore("SendNotification",{Text = "Set [" .. #util .. "] to \"" .. anim:GetFullName() .. "\""; Duration = 10; Title = "Saved Animation"})
end
